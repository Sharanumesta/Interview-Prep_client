...
const RoleInfoHeader = ({
  ...
  return (
    <div className="bg-white relative">
      <div className="container mx-auto px10 md:px-0">
        <div className="h-[200px] flex flex-col justify-center relative z-10">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="text-[10px] font-semibold text-white bg-black px-3 py-1 rounded-full">Last Updated: {lastUpdate}</div>
          </div>
        </div>
